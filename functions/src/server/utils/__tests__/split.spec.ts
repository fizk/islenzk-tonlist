import {splitContentType, splitGenre} from '../split';
...
describe('split', () => {
    ...
    describe('splitGenre', () => {
        ...
        test('type/style', () => {
            const expected = {type: 'type', style: 'style'};
            const actual = splitGenre('type/style');
            expect(actual).toEqual(expected);
        });

        test('type/style/attribute', () => {
            const expected = {type: 'type', style: 'style'};
            const actual = splitGenre('type/style');
            expect(actual).toEqual(expected);
        });
        ...
        test('type', () => {
            const expected = {type: 'type', style: undefined};
            const actual = splitGenre('type');
            expect(actual).toEqual(expected);
        });
    })
});
